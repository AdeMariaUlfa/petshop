...
$routes->get('/pelanggan', 'ProductController::pelanggan');
$routes->get('/product', 'ProductController::index');
$routes->get('/productAnjing', 'ProductController::indexAnjing');
$routes->get('/productIkan', 'ProductController::indexIkan');
$routes->get('/productReptil', 'ProductController::indexReptil');
...
$routes->get('/product/delete/(:segment)', 'ProductController::delete/$1');
